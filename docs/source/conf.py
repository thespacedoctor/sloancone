...
html_theme_options = {
    ...
    'github_repo': 'sloancone',
    'strap_line': "SDSS conesearching tools via the CL or Python API. Return conesearch results, or simply check whether or not a location in the sky has been covered by SDSS."
}
...
""" % locals()
link_resolver_url = "https://github.com/thespacedoctor/sloancone/tree/master"
...
exclude_patterns = ['_build', '_templates',
                    '**__version__.py', '**setup.py', 'api/sloancone.rst']
modindex_common_prefix = ["sloancone."]

# (source start file, target name, title, author, documentclass [howto/manual]).
latex_documents = [
    ('index', 'sloancone.tex', u'sloancone Documentation',
     u'Dave Young', 'manual'),
]
...
def updateUsageMd():
    ...
    *Grab the usage from cl_utils.py to display in README.md*
    """
    from sloancone import cl_utils
...
def generateAutosummaryIndex():
    ...
    # GET ALL SUBPACKAGES
    allSubpackages = ["sloancone"]
    allSubpackages += findAllSubpackges(
        pathToPackage="sloancone"
    )
